...
ALTER TABLE possui ADD CONSTRAINT FK_possui_2
 ...
 CREATE INDEX idx_user_endereco_user_id_user_endereco ON user_endereco_user (id_user, id_endereco);
...
-- Criando Cliente
INSERT INTO user_endereco_user(nome, tp_user, username, cpf, email, senha, dt_nasc, num_telefone, estado, cep, cidade, rua, id_endereco) VALUES ("Kauan", "pizzaiolo","Kauan", "01661638930", "rapedreira@gmail.com", md5("123"), "2002/05/12","41478666784", "Parana","81510220", "Curitiba", "Agostinho Brusamolin", 2);
